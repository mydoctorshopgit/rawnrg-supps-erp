...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::controller(PosController::class)->group(function () {
        ...
        Route::get('/pos/products/show', 'searchShow')->name('search.products');
        ...
        Route::post('/set-vat', 'setVat')->name('pos.set_vat');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified']], function () {
    Route::controller(SellerPosController::class)->group(function () {
        ...
        Route::get('/pos-configuration', 'pos_activation')->name('pos.configuration');
