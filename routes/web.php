...
Route::middleware('auth')->controller(HomeController::class)->group(function () {
    ...
    // Home Page
    Route::get('/', 'index')->name('home')->middleware(['prevent-back-history', 'auth', 'redirect.role']);
...
// Customer Accounts
// Route::resource('customer_information', CustomerProductController::class);
// Route::controller(CustomerProductController::class)->group(function () {
// // Route::get('/customer_products/{id}/edit', 'edit')->name('customer_products.edit');
// // Route::post('/customer_products/published', 'updatePublished')->name('customer_products.published');
// // Route::post('/customer_products/status', 'updateStatus')->name('customer_products.update.status');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('delivery/{order_id}', [InvoiceController::class, 'delivery_download'])->name('delivery.download');
