...
(function ($) {
    ...
    AIZ.uploader = {
        ...
        inputSelectPreviewGenerate: function (elem) {
            ...
            let inputAltName = elem.find(".selected-files").attr('data-image-alt');
            let inputAltExtName = elem.find(".selected-files").attr('data-extra-name') || '';
            let inputAltType = elem.find(".selected-files").attr('data-image-alt-type') == 'multiple' ? 'multiple' : 'single';
            let altValue = elem.find(".selected-files").attr('data-alt-value');
            console.log('Select',altValue);;
                        ...
                        if (data.length > 0) {
                            ...
                            for (var i = 0; i < data.length; i++) {
                                ...
                                if(inputAltName){
                                    altHtml =  `
                                    <div>
                                        <input type='text' class='form-control' name='${inputAltName}${inputAltType == 'multiple' ? "["+ data[i].id +"]" : ''}${inputAltExtName!=undefined ? inputAltExtName : ''}' placeholder='Alt Text' >
                                    </div>`;
                                }
        ...
        previewGenerate: function () {
            $('[data-toggle="aizuploader"]').each(function () {
                ...
                let inputAltName = $this.find(".selected-files").attr('data-image-alt');
                let inputAltExtName = $this.find(".selected-files").attr('data-extra-name') || '';
                let inputAltType = $this.find(".selected-files").attr('data-image-alt-type') == 'multiple' ? 'multiple' : 'single';
                let altValue = $this.find(".selected-files").attr('data-alt-value');
                            ...
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    ...
                                    if(inputAltName){
                                        altHtml =  `
                                        <div>
                                            <input type='text' class='form-control' value='${altValue[data[i].id]!=undefined ? altValue[data[i].id] : ''}' name='${inputAltName}${inputAltType == 'multiple' ? "["+ data[i].id +"]" : ''}${inputAltExtName!=undefined ? inputAltExtName : ''}' placeholder='Alt Text' >
                                        </div>`;
                                    }
    ...
    AIZ.plugins = {
        ...
        // textEditor: function () {
        //     $(".aiz-text-editor").each(function (index, el) {
        //         var $this = $(this);
        ...
        //                         "video",
        //                         "fileUpload",
        //                         "imageAttributes", // This enables the image attributes dialog
        //                     ],
        //                 ],
        ...
        //                 // Enable dialog fields you want to use
        //                 dialogFields: {
        //                     alt: {
        //                         label: 'Alt Text',
        //                         value: '',
        ...
        //                     ['remove', ['removeMedia']],
        //                     ['custom', ['imageAttributes']], // This adds the image attributes button to the popover
        //                 ],
        //             },
        //             callbacks: {
        ...
        //             $.ajax({
        //                 url: "/doctorShop/admin/upload-editor-file",
        //                 data: formData,
        //                 cache: false,
        //                 contentType: false,
        //                 processData: false,
        ...
        //                     if (response.url) {
        //                         // Insert image with empty alt attribute by default
        //                         var $img = $('<img>').attr('src', response.url).attr('alt', '');
        //                         editor.summernote('insertNode', $img[0]);
        //                     }
        //                 },
        //                 error: function (jqXHR, textStatus, errorThrown) {
        //                     console.error(
        //                         "Upload failed: " + textStatus,
        //                         errorThrown
        //                     );
        //                 },
        //             });
        ...
        aizUppy: function () {
            if ($("#aiz-upload-files").length > 0) {
                ...
                uppy.on("upload-success", function (res) {
