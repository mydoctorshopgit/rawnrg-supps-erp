...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>Credit Account Unconfirmation</title>
    <!-- Font Awesome CDN -->
...
<tr>
  <td style="padding: 30px; color: #000; font-size: 14px;">
    ...
    Thank you for your recent application for a credit account with us. 
    </span>
    <span style="display: block; line-height: 1.6; margin-bottom: 10px;">
   After careful review, we regret to inform you that your application has not been successful at this time. 
    </span>
    <span style="display: block; line-height: 1.6; margin-bottom: 10px;">
   However, to ensure you can still place orders with ease, we’ve created a registered user account for you on our website.<br>
You can log in using the following details:
    </span>

<!--<span style="display: block; color: #005eb8; font-weight: bold; margin-bottom: 10px;"> Credit Account Details:</span>-->

<table cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin-bottom: 10px;">
  <tr>
    <td style="font-weight: bold; padding: 5px 10px 5px 0; width: 120px;"> website</td>
    <td style="padding: 5px 0;"> <a href="https://mydoctorshop.com/" style="color: #005eb8; text-decoration: none;">My Doctor Shop</a></td>
  </tr>
  <tr>
    <td style="font-weight: bold; padding: 5px 5px 5px 0; width:200px;">Email:</td>
    <td style="padding: 5px 0;">{{$email}}</td>
  </tr>
  <tr>
    <td style="font-weight: bold; padding: 5px 5px 5px 0; width:200px;">Password:</td>
    <td style="padding: 5px 0;">{{$password}}</td>
  </tr>
  <!--<tr>-->
  <!--  <td style="font-weight: bold; padding: 5px 10px 5px 0;">Payment Terms:</td>-->
  <!--  <td style="padding: 5px 0;"> 30 days from the date of the invoice</td>-->
  <!--</tr>-->
</table>
    ...
    Once logged in, you can place orders and make payment securely at checkout.
    </span>
    <span style="display: block; line-height: 1.6; margin-bottom: 10px;">
    ...
    <span style="display: block; line-height: 1.6; margin-bottom: 2px;">
    You can view and manage your account details, including invoices and payment status, by logging into your <a href="https://mydoctorshop.com/login/">account login</a>.
    </span>
    <span style="display: block;  margin-bottom: 10px;">
     If you have any questions or require assistance, please don’t hesitate to <a href="https://mydoctorshop.com/contact/"> contact us</a>. <br>
    Thank you for choosing My Doctor Shop! We look forward to serving you.
    </span>
