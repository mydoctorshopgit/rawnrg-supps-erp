                  ...
                  <tr>
                    <td style="padding: 50px 10px">
                      <div
                        ...
                        "
                      >
                     Welcome to My Doctor Shop – Please Verify Your Email
                      </div>
   ...
   <tr>
    <td align="center" style="padding:70px 0 40px 0; background:#ffffff;">
        <table width="1000" cellpadding="0" cellspacing="0"
            style="background:#ffffff; border-radius:8px; border:1px solid #ddd; font-family:Arial, sans-serif;">
            ...
            <tr>
                <td style="padding:30px 40px; color:#333; font-size:14px; line-height:1.6;">
                    ...
                    <p style="margin:0 0 15px 0;">
                        Thank you for registering with My Doctor Shop.
                    </p>
                    ...
                    <p style="text-align:center; margin:25px 0;">
                        <a href="{{ $url }}"
                           style="background:#1a5dab; color:#ffffff; padding:8px 35px;
                    ...
                    <p style="margin:0 0 15px 0;">
                        ...
                        <strong> <a href="mailto:Acc@mydoctorshop.com"
                                    style="color:rgba(30, 30, 30, 1); text-decoration: none;">Acc@mydoctorshop.com</a>
                                </strong>.
                    </p>
