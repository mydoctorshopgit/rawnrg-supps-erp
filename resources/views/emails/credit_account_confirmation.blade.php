...
<html>
  <head>
    <meta charset="UTF-8" />
    <title>Credit Account Confirmation</title>
    <!-- Font Awesome CDN -->
...
<tr>
  <td style="padding: 30px; color: #000; font-size: 14px;">
    ...
    <span style="display: block; line-height: 1.6; margin-bottom: 10px;">
     We’re pleased to inform you that your credit account with My Doctor Shop has been successfully approved and is now active.
    </span>
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 100%; margin-bottom: 10px;">
  ...
  <tr>
    <td style="font-weight: bold; padding: 5px 5px 5px 0; width:200px;">Your Account Password:</td>
