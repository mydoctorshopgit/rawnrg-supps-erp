...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class=" align-items-center">
       <h1 class="h3">{{translate('Cancelled order report')}}</h1>
	</div>
</div>
...
<div class="row">
    <div class="col-md-12 mx-auto">
        <div class="card">
            <!--card body-->
            <div class="card-body">
                <form action="{{ route('cancelled_report.index') }}" method="GET">
                    ...
                    <div class="col-md-2">
                        <a class="btn btn-primary" href="{{ url('admin/cancelled/pdf/' . urlencode($date)) }}">
                            {{ translate('PDF Export') }}
                        </a>
                    </div>
                    <div class="col-md-2">
                        <a class="btn btn-primary" href="{{ url('admin/cancelled/excel/' . urlencode($date)) }}">
