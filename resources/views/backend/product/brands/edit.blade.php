                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <input type="hidden" name="logo" value="{{$brand->logo}}" class="selected-files" data-image-alt="logo_alt" data-image-alt-type="multiple" data-alt-value="{{ !empty($brand->logo_alt) ? $brand->logo_alt : '[]' }}">
                        </div>
