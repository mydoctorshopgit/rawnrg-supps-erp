...
<style>
    ...
    /* When open → change + to − */
    .child-categories:not(.d-none) ~ .category-toggle .toggle-icon {
        content: "−";
    }
</style>
...
<div class="page-content">
                            ...
                            <div class="w-100">
                                <div class="row">
                                    <div class="col-xxl-7 col-xl-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="name"
                                                    value="{{ old('name') }}" id="product_name"
                                                    placeholder="{{ translate('Product Name') }}"
                                                    onchange="update_sku()">
                                                <small class="text-info text-bold">Note: The product slug will be
                                                    automatically generated based on the product name. You can review or
                                                    edit it if needed.</small>
                                            </div>
                                        ...
                                        <div class="form-group row" id="brand">
                                            ...
                                            <div class="col-xxl-9">
                                                <select class="form-control aiz-selectpicker" name="brand_id"
                                                    ...
                                                    <option value="{{ $brand->id }}" @selected(old('brand_id')==$brand->
                                                        id)>{{ $brand->getTranslation('name') }}</option>
                                                    @endforeach
                                                </select>
                                                <small class="text-muted">{{translate("You can choose a brand if you'd
                                                    like to display your product by brand.")}}</small>
                                            </div>
                                        </div>
                                        <!-- Unit -->
                                        <div class="form-group row">
                                        ...
                                        <!-- Quantity -->
                                        <div class="form-group row">
                                            <label class="col-xxl-3 col-from-label fs-13">{{translate('Minimum Purchase
                                                Qty')}} <span class="text-danger">*</span></label>
                                            <div class="col-xxl-9">
                                                <input type="number" lang="en" class="form-control" name="min_qty"
                                                    value="1" min="1">
                                                <small class="text-muted">{{translate("The minimum quantity needs to be
                                                    purchased by your customer.")}}</small>
                                            </div>
                                        </div>
                                        <!-- Tags -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                ...
                                                <small class="text-muted">{{translate('This is used for search. Input
    ...
    <div class="h-300px overflow-auto c-scrollbar-light">
        <ul class="category-tree list-unstyled">
            ...
            <li>
                <input type="checkbox" name="category_ids[]" value="{{ $cat1->id }}"
                       class="category-checkbox"
                       {{ in_array($cat1->id, $old_categories ?? []) ? 'checked' : '' }}>

                <span class="category-toggle {{ $cat1->childrenCategories->isNotEmpty() ? 'has-children' : '' }}"
                      data-toggle="cat-{{ $cat1->id }}">

                    <span class="toggle-icon">
                        @if($cat1->childrenCategories->isNotEmpty()) + @endif
                    </span>

                    {{ $cat1->name }}
                </span>

                @if($cat1->childrenCategories->isNotEmpty())
                <ul id="cat-{{ $cat1->id }}" class="child-categories d-none ms-4">
                    @foreach($cat1->childrenCategories as $cat2)
                    <li>
                        <input type="checkbox" name="category_ids[]" value="{{ $cat2->id }}"
                               class="category-checkbox"
                               {{ in_array($cat2->id, $old_categories ?? []) ? 'checked' : '' }}>

                        <span class="category-toggle {{ $cat2->childrenCategories->isNotEmpty() ? 'has-children' : '' }}"
                              data-toggle="cat-{{ $cat2->id }}">

                            <span class="toggle-icon">
                                @if($cat2->childrenCategories->isNotEmpty()) + @endif
                            </span>

                            {{ $cat2->name }}
                        </span>

                        @if($cat2->childrenCategories->isNotEmpty())
                        <ul id="cat-{{ $cat2->id }}" class="child-categories d-none ms-4">
                            @foreach($cat2->childrenCategories as $cat3)
                            <li>
                                <input type="checkbox" name="category_ids[]" value="{{ $cat3->id }}"
                                       class="category-checkbox"
                                       {{ in_array($cat3->id, $old_categories ?? []) ? 'checked' : '' }}>

                                <span class="category-toggle {{ $cat3->childrenCategories->isNotEmpty() ? 'has-children' : '' }}"
                                      data-toggle="cat-{{ $cat3->id }}">

                                    <span class="toggle-icon">
                                        @if($cat3->childrenCategories->isNotEmpty()) + @endif
                                    </span>

                                    {{ $cat3->name }}
                                </span>

                                @if($cat3->childrenCategories->isNotEmpty())
                                <ul id="cat-{{ $cat3->id }}" class="child-categories d-none ms-4">
                                    @foreach($cat3->childrenCategories as $cat4)
                                    <li>
                                        <input type="checkbox" name="category_ids[]" value="{{ $cat4->id }}"
                                               class="category-checkbox"
                                               {{ in_array($cat4->id, $old_categories ?? []) ? 'checked' : '' }}>

                                        <span class="category-toggle {{ $cat4->childrenCategories->isNotEmpty() ? 'has-children' : '' }}"
                                              data-toggle="cat-{{ $cat4->id }}">

                                            <span class="toggle-icon">
                                                @if($cat4->childrenCategories->isNotEmpty()) + @endif
                                            </span>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Toggle subcategories + icon change
    document.querySelectorAll('.category-toggle.has-children').forEach(function (toggle) {
        toggle.addEventListener('click', function (e) {
            e.preventDefault(); // optional - prevents text selection

            const targetId = toggle.getAttribute('data-toggle');
            const targetUl = document.getElementById(targetId);

            if (targetUl) {
                targetUl.classList.toggle('d-none');

                // Change + ↔ −
                const icon = toggle.querySelector('.toggle-icon');
                if (icon) {
                    icon.textContent = targetUl.classList.contains('d-none') ? '+' : '−';
                }
            }
        });
    });

    // Auto-expand parents of already checked items + update icons
    document.querySelectorAll('.category-checkbox:checked').forEach(function (checkedBox) {
        let current = checkedBox.closest('li');
        while (current) {
            const parentToggle = current.parentElement?.previousElementSibling;
            if (parentToggle && parentToggle.classList.contains('category-toggle')) {
                const ul = document.getElementById(parentToggle.getAttribute('data-toggle'));
                if (ul) {
            ...
            current = current.parentElement?.closest('ul.child-categories')?.parentElement;
        }
    });
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <small class="text-muted">{{ translate('If you enable this, this product will be
                                            granted as a featured product.') }}</small>
                                    </div>
                                </div>
                                <!-- Todays Deal -->
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <small class="text-muted">{{ translate('If you enable this, this product will be
                                            granted as a todays deal product.') }}</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h5 class="mb-3 mt-4 pb-3 fs-17 fw-700" style="border-bottom: 1px dashed #e4e5eb;">
                                ...
                                <small class="text-muted">({{ translate('If you want to select this product as a flash
                                    deal, you can use it') }})</small>
                            </h5>
                            <div class="w-100">
                                <!-- Add To Flash -->
                                <div class="form-group row">
                    ...
                    <div class="tab-pane fade" id="files_and_media" role="tabpanel"
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                <!-- Gallery Images -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Gallery
                                        Images')}} <small>(600x600)</small></label>
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image"
                                            data-multiple="true" data-custom-type="gallery">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text bg-soft-secondary font-weight-medium">{{
                                                    translate('Browse')}}</div>
                                            </div>
                                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                            <input type="hidden" name="photos" class="selected-files" data-image-alt="gallery_alt" data-image-alt-type="multiple">
                                        </div>
                                        <div class="file-preview box sm">
                                        </div>
                                        <small class="text-muted">{{translate('These images are visible in product
                                            details page gallery. Use 600x600 sizes images.')}}</small>
                                    </div>
                                </div>
                                <!-- Thumbnail Image -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Thumbnail
                                        Image')}} <small>(300x300)</small></label>
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text bg-soft-secondary font-weight-medium">{{
                                            ...
                                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                            <input type="hidden" name="thumbnail_img" class="selected-files" data-image-alt="thumbnail_alt" data-image-alt-type="multiple">
                                        </div>
                                        <div class="file-preview box sm">
                                        </div>
                                        <small class="text-muted">{{translate('This image is visible in all product box.
                                            Use 300x300 sizes image. Keep some blank space around main object of your
                                            image as we had to crop some edge in different devices to make it
                                            responsive.')}}</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <small class="text-muted">{{translate("Use proper link without extra parameter.
                                        Don't use short share link/embeded iframe code.")}}</small>
                                </div>
                            </div>
                            <!-- PDF Specification -->
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('PDF
                                    Specification')}}</label>
                                <div class="col-md-9">
                    ...
                    {{-- <div class="tab-pane fade" id="price_and_stocks" role="tabpanel"
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row gutters-5">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control aiz-selectpicker" data-live-search="true"
                                            ...
                                            disabled>
                                            @foreach (\App\Models\Color::orderBy('name', 'asc')->get() as $key =>
                                            $color)
                                ...
                                <!-- Discount Date Range -->
                                <div class="form-group row">
                                    <label class="col-sm-3 control-label" for="start_date">{{translate('Discount Date
                                        Range')}}</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" placeholder="{{ translate('External link') }}"
                                            ...
                                            class="form-control">
                                        <small class="text-muted">{{translate('Leave it blank if you do not use external
                                            site link')}}</small>
                                    </div>
                                </div>
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Show Stock With Text
                                        Only')}}</label>
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                    ...
                    <div class="tab-pane fade" id="price_and_stocks" role="tabpanel"
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="form-group row mb-4">
                                <div class="col-md-12">
                                    <button type="button" class="btn btn-primary" onclick="addNewStock()">
                                        Add New Stock
                                    </button>
                                </div>
                            </div>
                            ...
                            <div id="stocks-container">
                                <!-- Default one empty stock entry for create -->
                                <div class="stock-entry" data-index="0">
                                    <input type="hidden" name="stocks[0][deleted]" value="0" class="delete-flag">
                                    <div class="w-100">
                                        <!-- Gallery Images -->
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group" data-toggle="aizuploader" data-type="image"
                                                    ...
                                                    <input type="hidden" name="stocks[0][photos]"
                                                        class="selected-files" data-image-alt="stocks[0][gallery_alt]" data-image-alt-type="multiple" >
                                                </div>
                                                <div class="file-preview box sm"></div>
                                                <small class="text-muted">
                                                    {{ translate('These images are visible in product details page
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                    ...
                                                    <input type="hidden" name="stocks[0][thumbnail_img]"
                                                        class="selected-files" data-image-alt="stocks[0][thumbnail_alt]" data-image-alt-type="multiple">
                                                </div>
                                                <div class="file-preview box sm"></div>
                                                <small class="text-muted">
                                                    {{ translate('This image is visible in all product box. Use 300x300
                                                    sizes image. Keep some blank space around main object of your image
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-from-label">
                                                {{ translate('Pip Code') }} <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" placeholder="{{ translate('pip code') }}"
                                                    name="stocks[0][pip_code]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-from-label">
                                                {{ translate('Product Code') }} <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" placeholder="{{ translate('product code') }}"
                                                    name="stocks[0][sku]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-from-label">
                                                {{ translate('Size') }} <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" placeholder="{{ translate('Size') }}"
                                                    name="stocks[0][variant]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-3 col-from-label">
                                                {{ translate('Flavour') }} <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-md-6">
                                                <input type="text" placeholder="{{ translate('flavour') }}"
                                                    name="stocks[0][flavour]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="{{ translate('color') }}"
                                                    name="stocks[0][color]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="{{ translate('quantity') }}"
                                                    name="stocks[0][qty]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" placeholder="{{ translate('price') }}"
                                                    name="stocks[0][price]" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xxl-9">
                                                <input type="text" class="form-control" name="stocks[0][pack_qty]">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="aiz-text-editor"
                                                    name="stocks[0][description]"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="aiz-text-editor"
                                                    name="stocks[0][short_description]"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea class="aiz-text-editor"
                                                    name="stocks[0][features]"></textarea>
                                                <small class="text-muted">{{ translate('Key features or highlights for this variant.') }}</small>
                                            </div>
                                        </div>

                                        <!-- Delete Button (hidden for the first entry in create mode) -->
                                        <div class="form-group row delete-row" style="display: none;">
                                            <div class="col-md-12">
                    ...
                    <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <!--Meta Image -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Meta
                                        Image') }}</label>
                                    <div class="col-md-9">
                                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                                            <div class="input-group-prepend">
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="faq-container">
                                        {{-- Existing entries if validation failed --}}
                                        @if(old('faq_questions'))
                                            ...
                                            <div class="faq-entry border rounded p-3 mb-3">
                                                <div class="form-group row mb-2">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" name="faq_questions[{{ $fi }}]"
                                                               class="form-control"
                                                ...
                                                <div class="form-group row mb-0">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea name="faq_answers[{{ $fi }}]" rows="3"
                                                                  class="form-control"
                                                                  placeholder="{{ translate('Enter answer') }}">{{ old("faq_answers.$fi") }}</textarea>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                            ...
                                            <div class="faq-entry border rounded p-3 mb-3">
                                                <div class="form-group row mb-2">
                                                    <label class="col-md-2 col-from-label">{{ translate('Question') }}</label>
                                                    <div class="col-md-10">
                                                        <input type="text" name="faq_questions[0]"
                                                               class="form-control"
                                                               placeholder="{{ translate('Enter question') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-0">
                                                    <label class="col-md-2 col-from-label">{{ translate('Answer') }}</label>
                                                    <div class="col-md-10">
                                                        <textarea name="faq_answers[0]" rows="3"
                                                                  class="form-control"
                    ...
                    <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Is Product Quantity
                                        Mulitiply')}}</label>
                                    <div class="col-md-9">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                ...
                                @else
                                <p>
                                    {{ translate('Product wise shipping cost is disable. Shipping cost is configured
                                    from here') }}
                    ...
                    <div class="mt-4 text-right">
                        <button type="submit" name="button" value="unpublish"
                            class="mx-2 btn btn-light w-230px btn-md rounded-2 fs-14 fw-700 shadow-secondary border-soft-secondary action-btn">{{
                            translate('Save & Unpublish') }}</button>
...
let stockIndex = 1; // Start from 1 because 0 is used for the first/default entry

function addNewStock() {
    const container = document.getElementById('stocks-container');

    const html = `
        <div class="stock-entry" data-index="${stockIndex}">
            <input type="hidden" name="stocks[${stockIndex}][deleted]" value="0" class="delete-flag">
            <div class="w-100">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group" data-toggle="aizuploader" data-type="image" data-multiple="true">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="stocks[${stockIndex}][photos]"  class="selected-files" data-image-alt="stocks[${stockIndex}][gallery_alt]" data-image-alt-type="multiple">
                        </div>
                        <div class="file-preview box sm"></div>
                        <small class="text-muted">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="stocks[${stockIndex}][thumbnail_img]" class="selected-files" data-image-alt="stocks[${stockIndex}][thumbnail_alt]" data-image-alt-type="multiple">
                        </div>
                        <div class="file-preview box sm"></div>
                        <small class="text-muted">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('pip code') }}"
                               name="stocks[${stockIndex}][pip_code]" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('product code') }}"
                               name="stocks[${stockIndex}][sku]" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('Size') }}"
                               name="stocks[${stockIndex}][variant]" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('flavour') }}"
                               name="stocks[${stockIndex}][flavour]" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('color') }}"
                               name="stocks[${stockIndex}][color]" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('quantity') }}"
                               name="stocks[${stockIndex}][qty]" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="{{ translate('price') }}"
                               name="stocks[${stockIndex}][price]" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xxl-9">
                        <input type="text" class="form-control" name="stocks[${stockIndex}][pack_qty]">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <textarea class="aiz-text-editor" name="stocks[${stockIndex}][description]"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <textarea class="aiz-text-editor" name="stocks[${stockIndex}][short_description]"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <textarea class="aiz-text-editor" name="stocks[${stockIndex}][features]"></textarea>
                        <small class="text-muted">{{ translate('Key features or highlights for this variant.') }}</small>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        <button type="button" class="btn btn-danger" onclick="deleteStock(this)">
                            Delete Stock
                        </button>
                    </div>
                </div>
    ...
    // Re-initialize AIZ Uploader for newly added fields
    AIZ.uploader.previewGenerate();

    // Optional: Re-initialize summernote for new textareas (if needed)
...
function deleteStock(btn) {
    if (confirm('{{ translate("Are you sure you want to delete this stock?") }}')) {
        const entry = btn.closest('.stock-entry');
        entry.querySelector('.delete-flag').value = '1';
        entry.style.display = 'none';
        // Optional: entry.remove(); if you prefer complete removal
    }
}
