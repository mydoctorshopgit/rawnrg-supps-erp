            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Color')}}" value="{{ $category->color }}" id="color" name="color"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Lite Color e.g. #f0f4ff')}}" value="{{ $category->lite_color }}" id="lite_color" name="lite_color"
                                class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{translate('Tagline')}}" value="{{ $category->tagline }}" id="tagline" name="tagline"
                                class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea placeholder="{{translate('Short Description')}}" id="short_description" name="short_description"
                                class="form-control" rows="3">{{ $category->short_description }}</textarea>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="aiz-text-editor" name="overview">{{ $category->overview }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Our Range')}}</label>
                        <div class="col-md-9">
                            <textarea class="aiz-text-editor" name="our_range">{{ $category->our_range }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Why Us')}}</label>
                        <div class="col-md-9">
                            <textarea class="aiz-text-editor" name="why_us">{{ $category->why_us }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div id="faqs-wrapper">
                                @php $existingFaqs = json_decode($category->faqs, true) ?? []; @endphp
                                @if(count($existingFaqs) > 0)
                                    @foreach($existingFaqs as $faqIndex => $faq)
                                        <div class="faq-row mb-3">
                                            <div class="input-group mb-2">
                                                <input type="text" name="faqs[{{ $faqIndex }}][question]" class="form-control" value="{{ $faq['question'] ?? '' }}" placeholder="{{ translate('Question') }}">
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-danger remove-faq-btn">{{ translate('Remove') }}</button>
                                                </div>
                                            </div>
                                            <div class="input-group">
                                                <textarea name="faqs[{{ $faqIndex }}][answer]" class="form-control" rows="3" placeholder="{{ translate('Answer') }}">{{ $faq['answer'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    @endforeach
                                @else
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="aiz-text-editor" name="content_description">{{ $category->content_description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control aiz-selectpicker" name="parent_id" data-toggle="select2"
                                ...
                                @include('backend.product.categories.categories_option', ['categories' =>
                                $categories]){{-- <option value="0">{{ translate('No Parent') }}</option>
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="banner" class="selected-files"
                                    value="{{ $category->banner }}" data-image-alt="banner_alt" data-image-alt-type="multiple" data-alt-value="{{ !empty($category->banner_alt) ? $category->banner_alt : '[]' }}">
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="icon" class="selected-files" value="{{ $category->icon }}" data-image-alt="icon_alt" data-image-alt-type="multiple" data-alt-value="{{ !empty($category->icon_alt) ? $category->icon_alt : '[]' }}">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <input type="hidden" name="cover_image" class="selected-files"
                                    value="{{ $category->cover_image }}" data-image-alt="cover_image_alt" data-image-alt-type="multiple" data-alt-value="{{ !empty($category->cover_image_alt) ? $category->cover_image_alt : '[]' }}">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                ...
                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                <input type="hidden" name="background_image" value="{{ $category->background_image }}" class="selected-files" data-image-alt="background_image_alt" data-image-alt-type="multiple" data-alt-value="{{ !empty($category->background_image) ? $category->background_image : '[]' }}">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    let faqIndex = {{ max(count(json_decode($category->faqs, true) ?? []), 1) }};
