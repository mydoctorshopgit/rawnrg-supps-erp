...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{ translate('List Last Bannars') }}</h1>
        </div>
        <div class="col text-right">
            <a href="{{ route('lastBannar.create') }}" class="btn btn-circle btn-info">
                    ...
                    <tr>
                       ...
                       <td>
                        ...
                        <td class="text-right">
                            ...
                            <a href="{{ route('lastBannar.edit', $bannar->id) }}"
                                class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                title="{{ translate('Edit this Customer') }}">
                                <i class="las la-edit"></i>
                            </a>
                         
                             <a href="{{ route('lastBannar.delete', $bannar->id) }}"
...
function showCustomModal(el) {
    ...
    let status = el.checked ? 4 : 0; 

    fetch("{{ route('lastStatus.update') }}", {
        method: "POST",
        headers: {
