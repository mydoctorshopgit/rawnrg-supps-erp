...
@section('content')
    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            <div class="col-auto">
                <h1 class="h3">{{ translate('List Best Seller Bannars') }}</h1>
            </div>
            <div class="col text-right">
                <a href="{{ route('BestSellerBannar.create') }}" class="btn btn-circle btn-info">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @can('login_as_customer')
                                        <a href="{{ route('BestSellerBannar.edit', $bannar->id) }}"
                                            class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                            title="{{ translate('Edit this Customer') }}">
                                            <i class="las la-edit"></i>
                                        </a>

                                        <a href="{{ route('BestSellerBannar.delete', $bannar->id) }}"
...
@section('script')
    ...
    <script>
        function showCustomModal(el) {
            ...
            let status = el.checked ? 5 : 0;

            fetch("{{ route('BestSellerStatus.update') }}", {
                    method: "POST",
                    headers: {
