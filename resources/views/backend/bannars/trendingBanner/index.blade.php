    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            ...
            <div class="col text-right">
                <a href="{{ route('trendingBannar.create') }}" class="btn btn-circle btn-info">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @can('login_as_customer')
                                        <a href="{{ route('trendingBannar.edit', $bannar->id) }}"
                                            class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                            title="{{ translate('Edit this Customer') }}">
                                            <i class="las la-edit"></i>
                                        </a>

                                        <a href="{{ route('trendingBannar.delete', $bannar->id) }}"
...
@section('script')
    ...
    <script>
        function showCustomModal(el) {
            ...
            fetch("{{ route('trendingStatus.update') }}", {
                    method: "POST",
                    headers: {
