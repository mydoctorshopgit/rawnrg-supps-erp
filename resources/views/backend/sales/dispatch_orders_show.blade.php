        ...
        <div class="card-body">
            <div class="row gutters-5">
                ...
                @if ($order->seller_id == $admin_user_id || get_setting('product_manage_by_admin') == 1)
                    ...
                    <div class="col-md-3 ml-auto">
                        <label for="update_payment_status">Carrier Name</label>
            ...
            <div class="clearfix float-right">
                ...
                <div class="no-print text-left">
                    <button type="button" class="btn  btn-primary" id="send_to_dispatch"  ><i
                            class="las la-arrow"></i> Send to Fullfillment Order</button>
                </div>
        ...
        $('#notes').on('change', function() {
         ...
         $('#send_to_dispatch').on('click', function() {
            ...
            $.post('{{ route('orders.status') }}', {
                ...
                AIZ.plugins.notify('success', '{{ translate('Status has been fulupdated') }}');
