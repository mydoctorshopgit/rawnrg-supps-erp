...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="h2 fs-16 mb-0">{{ translate('Cancelled Details') }}</h1>
        </div>
    <div class="card-body">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-info text-bold text-right"> {{ $order->purchase_order_number }}</td>
                                <td class="text-main text-bold">&nbsp;&nbsp;</td>
                        ...
                        <thead>
                            <tr class="bg-trans-dark">
                                ...
                                <th data-breakpoints="lg" class="min-col text-uppercase text-center">
                                 ...
                                 <th data-breakpoints="lg" class="min-col text-uppercase text-center">{{ translate('Picked Qty') }}</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="form-group">
                        <input type="number" id="editPrice" class="form-control d-none" min="0" step="0.01" required>
                    </div>
                    <div class="form-group">
           ...
           {{--      <div class="no-print text-left">
                    ...
                    @else
                    <button type="button" class="btn  btn-primary" id="send_to_dispatch"  ><i
                            class="las la-arrow"></i>  Send to Fullfillment </button>
                              <button type="button" class="btn  btn-danger" id="order_cancelled"  ><i
                                class="las la-arrow"></i>  Cancelled Order </button>
                    @endif
                </div> --}}
