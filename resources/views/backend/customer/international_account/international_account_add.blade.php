...
<div class="page-content">
    <div class="aiz-titlebar text-left mt-2 pb-2 px-3 px-md-2rem border-bottom border-gray">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="h3">{{ translate(' Guest Customer Account') }}</h1>
            </div>
                        ...
                        <form method="POST" id="register_credit_form">
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control" id="email_common" name="email"
                                        value="{{ $user?->mobile_number ?? '' }}" placeholder="Type here">
                                </div>
                            </div>


                            <div class="d-flex justify-content-end mt-4">
                                <button type="button" id="register/creditButton" class="btn btn-primary">Next</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="files_and_media" role="tabpanel" aria-labelledby="files-and-media-tab">
                    <div class="bg-white p-3 p-sm-2rem">
                        ...
                        <form method="POST" id="delivery_form">
                            ...
                            <div class="row g-3 mt-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="county" name="county"
                                        placeholder="Type here" value="">
                                    <span class="error-message" id="county-error" style="color:red; display:none;">This
                                        field
                                        is required.</span>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="country" name="country" class="form-control aiz-selectpicker">
                                        ...
                                        <option value="{{ $country->id }}" {{-- {{ isset($user) && $user?->
                                            registerCredit?->creditDelivery?->first()?->country == $country->id ?
                                            'selected' : '' }} --}}>
                                            {{ $country->name }}</option>
                                        @endforeach
                                    </select>
                                    <span class="error-message" id="country-error" style="color:red; display:none;">This
                                        field is required.</span>
                                </div>
                            ...
                            {{-- line - 5 --}}
                            <br>
                            <button type="button" id="submitButton" val="" class="btn btn-primary">Save</button>
...
<script>
    $(document).ready(function() {
        ...
        document.getElementById('register/creditButton').addEventListener('click', function() {
            ...
            fetch('{{ route('customer_guest.store') }}', {
                    method: 'POST',
                    headers: {
        ...
        document.getElementById('submitButton').addEventListener('click', function() {
            ...
            fetch('{{ route('delivery_guest_form.store') }}', {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute(
                            'content'),
            ...
            fetch('{{ route('changeStatus3') }}', {
                ...
                .then(data => {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = "{{ route('customer_guest.list') }}?status=success";
                    })
