                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!--</td>-->
                         ...
                         <td>
                            @if(isset($user->registerCredit->mobile_number))
                        ...
                        <td class="text-right">
                            ...
                            <a href="{{ route('international_register_customer', $user->id) }}"
                                class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                title="{{ translate('Edit this Customer') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="{{ route('international_register_customer_view', $user->id) }}"
                            ...
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                data-href="{{ route('international_register_customer_delete', $user->id) }}"
