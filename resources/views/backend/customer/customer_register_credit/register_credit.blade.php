    ...
    <div class="page-content">
        <div class="aiz-titlebar text-left mt-2 pb-2 px-3 px-md-2rem border-bottom border-gray">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="h3">{{ translate(' Credit Customer Account') }}</h1>
                </div>
                                ...
                                <div id="dynamic-sections">
                                    <div id="section-1-2" class="dynamic-content d-none">
                                        <div class="row g-3 mt-2">
                                            ...
                                            name="phone_number" placeholder="Type here">
                                        ...
                                        <div class="row g-3 mt-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="department_name"
                                                    ...
                                                    value="{{ $user?->registerCredit->department_name ?? '' }}"
                                                    placeholder="Type here" required>
                                            </div>
                                        </div>
                                    </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    <script>
        ...
        document.getElementById('register/creditButton').addEventListener('click', function() {
            ...
            fetch('{{ route('customer_credit.store') }}', {
                    method: 'POST',
                    headers: {
        ...
        <td>${data.country || '-'}</td>
          <td>
            <button type='button' class="btn btn-danger btn-sm delete-row-btn" title="Delete">
