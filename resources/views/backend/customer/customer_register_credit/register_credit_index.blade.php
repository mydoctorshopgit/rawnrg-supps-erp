...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{ translate('List Credit Customers') }}</h1>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span
                                class="badge w-50
                            {{ $user->is_approved == 2 ? 'bg-success' : ($user->is_approved == 0 ? 'bg-warning' : 'bg-danger ') }}">
                                {{ $user->is_approved == 2 ? "Approved" : ($user->is_approved == 0 ? "Pending" :
                                "Rejected") }}
                            </span></ </td>
                        ...
                        <td>
                            <label class="switch">
                                <input type="checkbox" class="showModalCheckbox" data-user-id="{{ $user->id }}"
                                    onchange="showCustomModal(this)" {{ $user->is_approved == 2 ? 'checked' : '' }}>
                        ...
                        <td class="text-right">
                            ...
                            <a href="{{ route('credit_customer', $user->id) }}"
                                class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                title="{{ translate('Edit this Customer') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="{{ route('credit_customer_view', $user->id) }}"
                                class="btn btn-soft-success btn-icon btn-circle btn-sm" title="{{ translate('View') }}">
                                <i class="las la-eye"></i>
                            </a>
                            <a href="#"
                                class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete"
                                data-href="{{ route('credit_customer_delete', $user->id) }}"
                                title="{{ translate('Trash') }}">
                                <i class="las la-trash"></i>
                            </a>
                            <!--<a href="{{ route('credit_customer_delete', $user->id) }}" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-id="{{ $user->id }}" title="{{ translate('Delete') }}">-->
                            <!--    <i class="las la-trash"></i>-->
                            <!--</a>-->
                            @endcan
                        </td>
