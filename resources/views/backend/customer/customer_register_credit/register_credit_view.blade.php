              ...
              <tr>
                ...
                <tr>
                  ...
                  @if(!empty($User?->registerCredit?->company_name))
                   ...
                   @endif
                    @if(!empty($User?->registerCredit?->organization_name))
                   <tr>
                   ...
                   <tr>
                    ...
                    <td>
                        ...
                        {{ $User->is_approved == 2 ? "Approved" : ($User->is_approved == 0 ? "Pending" : "Rejected") }}
                    </span>
                    </td>
                   </tr>
                    @if(!empty($User?->registerCredit?->url))
                   <tr>
                    ...
                    @endif
                     @if(!empty($User?->registerCredit?->department_name))
                   <tr>
                    ...
                    @endif
                     @if(!empty($User?->registerCredit?->statement_email))
                   <tr>
                   ...
                   <tr>
                    ...
                    @endif
                     @if(!empty($User?->registerCredit?->mobile_number))
                   <tr>
