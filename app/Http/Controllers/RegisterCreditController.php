...
class RegisterCreditController extends Controller
{

    public function customerCreditList()
    {

        // $users = User::where('user_type', 'customer_credit')
        //              ->where('is_completed', '1')
        //              ->orderByRaw("FIELD(is_approved, 0, 2, 1)")
        //                  ->get();
        ...
        $users = User::where('users.user_type', 'customer_credit')
        ...
        return view('backend.customer.customer_register_credit.register_credit_index', compact('users'));
    }
    ...
    public function customerRegisterList()
    {
        ...
        return view('backend.customer.register_account.register_index', compact('users'));
    }

    public function credit_customer_delete($id)
    {
        // Get the specific user
        $user = User::where('id', $id)->where('user_type', 'customer_credit')->first();
        ...
        return redirect()->route('customer_credit.list')->with('success', 'Customer deleted successfully.');
    }
    public function register_customer_delete($id)
    {
        ...
        return redirect()->route('customer_register.list')->with('success', 'Customer deleted successfully.');
    }
    ...
    public function register_customer($id = null)
    {
        ...
        return view('backend.customer.register_account.register')->with($data);
    }
