...
*/
    ...
    public function multiDelivery(Request $request)
    {
        ...
        $addresses = CreditDelivery::where('credit_id', $user->id)->get();
       ...
       if ($addresses->isEmpty()) {
        ...
        return response()->json([
            ...
            'phone'   => optional($user->registerCredit)->mobile_number ?? $user->mobile_number,
            'addresses' => $addresses,
        ]);
    }
